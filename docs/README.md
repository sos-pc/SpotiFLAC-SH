...
| [service-selection-map.md](service-selection-map.md) | 🔍+🧭 | 🗺️ carte, non commencé | **2026-07-17**, lecture directe du code | Comment le service de téléchargement est choisi : **4 couches** de décision, l'override `jobs_helpers.go:263` qui bloque S6, pièges de nommage. Décisions produit ouvertes en §6. Préalable au portage S6. |
