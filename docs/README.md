...
| **Refonte API** | [api-redesign-plan.md](api-redesign-plan.md) | 🟢 **phases 1-4 faites**, vérifiées en prod. Audit des 76 routes : **1 élévation de privilège trouvée et corrigée** | 2 décisions posées, non tranchées : catalogue `admin`→`read`, explorateur BoltDB |
