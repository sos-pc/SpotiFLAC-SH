...
function drawRealSpectrum(ctx: CanvasRenderingContext2D, x: number, y: number, width: number, height: number, spectrum: SpectrumData) {
...
function drawAxesAndLabels(ctx: CanvasRenderingContext2D, x: number, y: number, width: number, height: number, nyquistFreq: number, duration: number, sampleRate: number) {
...
function drawColorBar(ctx: CanvasRenderingContext2D, x: number, y: number, width: number, height: number) {
