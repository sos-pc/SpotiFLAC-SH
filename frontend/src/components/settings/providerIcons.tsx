// Provider brand icons shared between the Settings tab bar, the General tab's
// source/order selectors, and elsewhere. Extracted from SettingsPage during
// the R1 split so both the parent shell and the GeneralTab component can use
...
export const QobuzIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`inline-block w-[1.1em] h-[1.1em] mr-2 ${className || "fill-muted-foreground"}`}
  >
...
export const AmazonIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`inline-block w-[1.1em] h-[1.1em] mr-2 ${className || "fill-muted-foreground"}`}
  >
